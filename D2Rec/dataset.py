...
class Dataset(data.Dataset):
    def __init__(self, root, transform, target_transform, image_size, dataset_name, mode='test', anomaly_path=None):
        self.root = root
        ...
        self.perlinpaste_transform = PerlinPaste(anomaly_dir=anomaly_path)
