...
def main():
    ...
    parser.add_argument("--visual_path", type=str, default="ckpt/t")
    parser.add_argument("--visualize", action="store_true")
    parser.add_argument("--image_adapt_weight", type=float, default=0.1)
    parser.add_argument("--save_path", default="ckpt/t")
    ...
    for checkpoint_path in files:
        ...
        numeric_cols = ["pixel AUC", "pixel AP", "pixel AUPRO", "pixel F1",
                        "image AUC", "image AP", "image F1"]
