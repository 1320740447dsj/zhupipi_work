...
try:
    ...
    class version:
        parse = staticmethod(LooseVersion)
import torch
import numpy as np
...
class AnomalyCLIP_PromptLearner(nn.Module):
    def __init__(self, clip_model, design_details):
        ...
        if ctx_init_pos and ctx_init_neg:
            ...
            #杩欎簺鏄幓闄ゅ嚭鏉OS 鍜?# CLS, EOS锛?鑾峰緱鍙涔犵殑textual prompt
            ...
            if True:
                ...
                #杩欓噷鏄痗ls鏄被鐨勪釜鏁帮紝n_ctx_pos浠ｈ〃learnable token鐨勯暱搴︼紝ctx_dim琛ㄧずprompt鐨刣imension
